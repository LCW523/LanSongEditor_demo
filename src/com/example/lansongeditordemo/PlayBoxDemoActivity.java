...
public class PlayBoxDemoActivity extends Activity implements OnClickListener,OnSeekBarChangeListener {
    ...
    public static void intentTo(Context context, String videoPath) {
    	  Intent intent = new Intent(context, PlayBoxDemoActivity.class);
    ...
    private void startPlayer2()
    {
    	  mVPlayer2=new VPlayer(this);
	   	  mVPlayer2.setVideoPath(mVideoPath);
	   	  mVPlayer2.setOnPreparedListener(new OnPreparedListener() {
				
				@Override
				public void onPrepared(IMediaPlayer mp) {
					// TODO Auto-generated method stub
					mAlphaVideoSprite=mPlayView.obtainAlphaVideoSprite();
					if(mAlphaVideoSprite!=null){
						mVPlayer2.setSurface(new Surface(mAlphaVideoSprite.getVideoTexture()));	
						mAlphaVideoSprite.setScale(30);
					}
					mVPlayer2.start();
				}
			});
	...
	public void onProgressChanged(SeekBar seekBar, int progress,
		...
		if(seekBar==skbarRotate){
			if(mAlphaVideoSprite!=null)
				mAlphaVideoSprite.setRotate(progress);
		}
		if(seekBar==skbarMove){
			if(mAlphaVideoSprite!=null){
				...
				mAlphaVideoSprite.setPosition(xpos, ypos);
			}
		}
		if(seekBar==skbarScale){
			if(mAlphaVideoSprite!=null){
				mAlphaVideoSprite.setScale(progress);
			}
		}
